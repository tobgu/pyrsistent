...
from pyrsistent.typing import PSequence as PSequence
from pyrsistent.typing import PSequenceEvolver as PSequenceEvolver
...
def pseqeuence(iterable: Optional[Iterable[T]] = None) -> PSequence[T]: ...
def sq(*iterable: T) -> PSequence[T]: ...
