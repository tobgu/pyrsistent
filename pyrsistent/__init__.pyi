...
def pvector(iterable: Iterable[T] = ...) -> PVector[T]: ...  # type: ignore[reportGeneralTypeIssues]
...
class PRecord(PMap[AnyStr, Any]):
    ...
    def discard(self: T_PRecord, key: KT) -> T_PRecord: ...  # type: ignore[reportGeneralTypeIssues]
    def remove(self: T_PRecord, key: KT) -> T_PRecord: ...  # type: ignore[reportGeneralTypeIssues]
    ...
    @overload
    def set(self, key: KT, val: VT) -> Any: ...  # type: ignore[reportGeneralTypeIssues]
    @overload
    def set(self, **kwargs: VT) -> Any: ...  # type: ignore[reportGeneralTypeIssues]
