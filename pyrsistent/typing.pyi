...
# Types for Checked collections are actually determined by the __type__ dunders,
# but this should provide better type safety than using Any

class CheckedPMap(PMap[KT, VT]):
    def __new__(cls, source: Mapping[KT, VT] = ..., size: int = ...) -> None: ...
    @classmethod
    def create(cls, source_data: Mapping[KT_, VT_], _factory_fields: Any = ...) -> CheckedPMap[KT_, VT_]: ...
    def serialize(self, format: Optional[str] = ...) -> Dict[KT, VT]: ...


class CheckedPVector(PVector[T]):
    def __new__(self, initial: Iterable[T] = ...) -> None: ...
    @classmethod
    def create(cls, source_data: Iterable[T_], _factory_fields: Any = ...) -> CheckedPVector[T_]: ...
    def serialize(self, format: Optional[str] = ...) -> List[T]: ...


class CheckedPSet(PSet[T]):
    def __new__(cls, initial: Iterable[T] = ...) -> None: ...
    @classmethod
    def create(cls, source_data: Iterable[T_], _factory_fields: Any = ...) -> CheckedPSet[T_]: ...
    def serialize(self, format: Optional[str] = ...) -> Set[T]: ...
