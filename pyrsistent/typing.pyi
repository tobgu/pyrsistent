...
class CheckedPMap(PMap[KT, VT]):
    ...
    @staticmethod
    def create(source_data: Mapping[KT_, VT_], _factory_fields: Any = ...) -> CheckedPMap[KT_, VT_]: ...
...
class CheckedPVector(PVector[T]):
    ...
    @staticmethod
    def create(source_data: Iterable[T_], _factory_fields: Any = ...) -> CheckedPVector[T_]: ...
...
class CheckedPSet(PSet[T]):
    ...
    @staticmethod
    def create(source_data: Iterable[T_], _factory_fields: Any = ...) -> CheckedPSet[T_]: ...
