...
class PSequenceBase(Sequence[T], Hashable):
    ...
    def extendleft(self, other:Iterable[T]) -> PSequence[T]: ...
    def extendright(self, other:Iterable[T]) -> PSequence[T]: ...
    def extend(self, other:Iterable[T]) -> PSequence[T]: ...
    def __add__(self, other:Iterable[T]) -> PSequence[T]: ...
    @overload
    def __getitem__(self, index:int) -> T: ...
    @overload
    ...
    @overload
    def mset(self, *values:Iterable[Union[T, int]]) -> PSequence[T]: ...
    @overload
    ...
    def remove(self) -> PSequence[T]: ...
    def __mul__(self, times:int) -> PSequence[T]: ...
    def __rmul__(self, times:int) -> PSequence[T]: ...
    def __hash__(self) -> int: ...
    def __iter__(self) -> Iterator[T]: ...
    ...
    def append(self, value:T) -> PSequence[T]: ...
    def count(self, value:T) -> int: ...
    def index(self, value:T) -> int: ...
    def splitat(self, index:int) -> Tuple[PSequence[T], PSequence[T]]: ...
    def chunksof(self, size:int) -> PSequence[PSequence[T]]: ...
    @property
    def left(self) -> T: ...
    @property
    def right(self) -> T: ...
    ...
    def evolver(self) -> PSequenceEvolver: ...
...
class PSequenceEvolver(MutableSequence[T]):
    ...
    def __ge__(self, other:Iterable[T]) -> bool: ...
    def __gt__(self, other:Iterable[T]) -> bool: ...
    def extendleft(self, other:Iterable[T]) -> PSequenceEvolver[T]: ...
    def extendright(self, other:Iterable[T]) -> PSequenceEvolver[T]: ...
    def extend(self, other:Iterable[T]) -> PSequenceEvolver[T]: ...
    def __add__(self, other:Iterable[T]) -> PSequenceEvolver[T]: ...
    @overload
    def __getitem__(self, index:int) -> T: ...
    @overload
    def __getitem__(self, index:slice) -> PSequence[T]: ...
    @overload
    def set(self, index:int, value:T) -> PSequenceEvolver[T]: ...
    @overload
    def set(self, index:slice, value:Iterable[T]) -> PSequenceEvolver[T]: ...
    @overload
    def __setitem__(self, index:int, value:T) -> PSequenceEvolver[T]: ...
    @overload
    def __setitem__(self, index:slice, value:Iterable[T]) -> PSequenceEvolver[T]: ...
    @overload
    def mset(self, *values:Iterable[Union[T, int]]) -> PSequenceEvolver[T]: ...
    @overload
    def mset(self, *values:Tuple[Int, T]) -> PSequenceEvolver[T]: ...
    def insert(self, index:int, value:T) -> PSequenceEvolver[T]: ...
    @overload
    def delete(self, index:int) -> PSequenceEvolver[T]: ...
    @overload
    def delete(self, index:slice) -> PSequenceEvolver[T]: ...
    @overload
    def __delitem__(self, index:int) -> PSequenceEvolver[T]: ...
    @overload
    def __delitem__(self, index:slice) -> PSequenceEvolver[T]: ...
    def remove(self, value:T) -> PSequenceEvolver[T]: ...
    def __mul__(self, times:int) -> PSequenceEvolver[T]: ...
    def __rmul__(self, times:int) -> PSequenceEvolver[T]: ...
    def __hash__(self) -> int: ...
    def __iter__(self) -> Iterator[T]: ...
    def __reversed__(self) -> Iterator[T]: ...
    def __len__(self) -> int: ...
    ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def appendleft(self, value:T) -> PSequenceEvolver[T]: ...
    def appendright(self, value:T) -> PSequenceEvolver[T]: ...
    def append(self, value:T) -> PSequenceEvolver[T]: ...
    def count(self, value:T) -> int: ...
    def index(self, value:T) -> int: ...
    def splitat(self, index:int) -> Tuple[PSequence[T], PSequence[T]]: ...
    def chunksof(self, size:int) -> PSequence[PSequence[T]]: ...
    ...
    def viewright(self) -> Tuple[PSequence[T], T]: ...
    def view(self, *index:int) -> tuple[Union[T, PSequence[T]], ...]: ...
    def reverse(self) -> PSequenceEvolver[T]: ...
    def tolist(self) -> list[T]: ...
    def totuple(self) -> tuple[T, ...]: ...
    def transform(self, *transformations: Any): ...
    def sort(self, *args, **kwargs) -> PSequenceEvolver[T]: ...
    def popleft(self) -> T: ...
    def popright(self) -> T: ...
    @overload
